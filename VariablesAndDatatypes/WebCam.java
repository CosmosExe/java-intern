class WebCam{
	...
	static String type = "Action Camera";
	static String modelName = "C270";
	static String originCountry = "China";
	static String modelNumber = "960-000584";
	static String connectivity = "USB";
	static String colour = "Black";
	static String quality = "720p";
	static int price = 2175;
	static String format = "AVCHD";
	public static void main(String[] hd){
		/*String brandName = "Logitech";
		String type = "Action Camera";
		String modelName = "C270";
		String originCountry = "China";
		String modelNumber = "960-000584";
